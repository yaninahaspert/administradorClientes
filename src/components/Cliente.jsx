...
import {eliminarCliente} from "../data/clientes.jsx";
            ...
            <tr className="border-b">
                ...
                <td className="p-6">
                    <p className="text-gray-600"><span
                        className="text-gray-800 uppercase font-bold">Email: </span>{email}</p>
                    <p className="text-gray-600"><span
                        className="text-gray-800 uppercase font-bold">Tel: </span>{telefono}</p>
                </td>

                <th className="p-6 flex gap-3">
